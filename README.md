# Tour de App - SvelteKit + Express Boilerplate

> **Note:** Czech version is available below / Česká verze je k dispozici níže

A template for developing applications for the Tour de App competition with a frontend in [SvelteKit](https://svelte.dev/docs/kit) and a backend in [Express](https://expressjs.com/).
...
Šablona pro vývoj aplikace v soutěži Tour de App společně s frontendovou částí ve frameworku [SvelteKit](https://svelte.dev/docs/kit) a backendovou částí v [Express](https://expressjs.com/).
